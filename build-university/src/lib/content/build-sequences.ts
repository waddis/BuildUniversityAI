...
export const ROOF_CONSTRUCTION: DamageScenario = {
  ...
  stops: [
    ...
    {
      ...C([15, 7, 11], [8.5, 2, 2.2], 34),
      title: '6 · Valley Metal',
      narration: 'Where two roof planes meet, an open valley gets metal flashing over the ice-and-water barrier. The W-profile crimp keeps the two sides of runoff separated. Fasteners stay outside the water channel — nailing in the flow path is one of the most common valley leaks.',
      annotationIds: [],
      visibleGroups: L6,
    },
    {
      ...
      narration: 'Where the roof meets a wall, step flashing is woven in — one bent piece per shingle course, each lapped over the one below. It is never a single continuous strip. Done right, water on the wall is always directed out onto the roof surface, never behind it.',
      annotationIds: [],
      visibleGroups: L7,
    },
    {
    ...
    {
      ...C([17, 14, 18], [1, 2, 0], 44),
      title: '10 · Finished Roof',
      narration: 'Every layer in order — structure, deck, underlayment, ice-and-water barrier, drip edge, valley metal, step flashing, covering, ridge cap, and eave trim. Each one depends on the one beneath it. When you inspect a roof, you are reading this stack in reverse.',
      annotationIds: [],
      visibleGroups: L10,
    },
  ],
